...
import type { PlaywrightTestInfo } from '../types.js';
...
export class Logger {
    ...
    private playwrightTestInfo: PlaywrightTestInfo | null = null;
     ...
     */
    public setTestInfo(testInfo: PlaywrightTestInfo): void {
